package com.cbr.ilk.camundapostgreskotlin.camundaTests
...
object ProcessConstants {
    const val PROCESS_DEFINITION_KEY = "Process_027hatc" // BPMN Process ID
...
class ProcessEngineExtension(
    ...
    companion object {
        ...
        operator fun invoke(configuration: ProcessEngineConfigurationImpl): ProcessEngineExtension =
            ProcessEngineExtension(configuration.buildProcessEngine())
    }
